...
namespace ExTrack
{
    public partial class CreateWorkoutNotFixed : Form
    {
        public CreateWorkoutNotFixed()
        {
            InitializeComponent();
        }
        ...
        private void CreateWorkoutNotFixed_Load(object sender, EventArgs e)
        {
