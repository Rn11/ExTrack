...
namespace ExTrack
{
    public partial class WorkoutNotFixed : Form
    {
        public int index = 0;
        public double points = 0;
        protected bool isLoaded = false;

        public WorkoutNotFixed()
        {
            InitializeComponent();
        }

        private MainForm mainForm = null;
        public WorkoutNotFixed(Form callingForm)
        {
        ...
        private void enterNext()
        {
            ...
            else
            {
                ...
                sb.Append(string.Format("{0}\t", (lvPlan.Items[index].Text)));
                 ...
                 //do NOT append subitem reps, lol 
                ////append subitem reps
        ...
        private void btnNextEx_Click(object sender, EventArgs e)
        {
            //check if training is finished
